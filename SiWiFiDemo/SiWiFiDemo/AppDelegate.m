...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSArray *productKeys = [NSArray arrayWithObject:@"c20ad4d76fe97759aa27a0c99678"];
    
    [manager initializeManager:@"d89a8dc167ac60ad923fda4abcdef" andRouterKeys:productKeys];
...
//登录
-(void) userLogin{
    [manager userLogin:@"43fbf9db189a937511658743a4745456" andAppKey:@"d89a8dc167ac60ad923fda4abcdef" onresult:^(id ret, int code, NSString *msg){
        if(code == 0){
